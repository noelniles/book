...
when I was a child. Remember, drawing the frame over the dividend and then
placing the divisor on the left. Then you would try to think how many times
you could multiply the left number (the divisor) until you got a remainder that
was less then the divisor. This process is called Euclidean Division.
